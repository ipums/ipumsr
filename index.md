...
[`vignette("ipums")`](https://tech.popdata.org/ipumsr/articles/ipums.md)
...
- To read IPUMS data extracts into R, see
  [`vignette("ipums-read")`](https://tech.popdata.org/ipumsr/articles/ipums-read.md).
...
- For additional details about microdata and aggregate data extract
  requests, see
  [`vignette("ipums-api-micro")`](https://tech.popdata.org/ipumsr/articles/ipums-api-micro.md)
  and
...
- To work with labelled values in IPUMS data, see
  [`vignette("value-labels")`](https://tech.popdata.org/ipumsr/articles/value-labels.md).

- For techniques for working with large data extracts, see
  [`vignette("ipums-bigdata")`](https://tech.popdata.org/ipumsr/articles/ipums-bigdata.md).
