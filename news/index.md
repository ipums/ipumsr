...
- Functions
  [`define_extract_usa()`](https://tech.popdata.org/ipumsr/reference/define_extract_micro.md),
  [`define_extract_cps()`](https://tech.popdata.org/ipumsr/reference/define_extract_micro.md),
  and
  [`define_extract_ipumsi()`](https://tech.popdata.org/ipumsr/reference/define_extract_micro.md)
...
- This release adds comprehensive support for IPUMS IHGIS extract
  ...
  - [`read_ipums_agg()`](https://tech.popdata.org/ipumsr/reference/read_ipums_agg.md)
    ...
    [`read_nhgis()`](https://tech.popdata.org/ipumsr/reference/read_nhgis.md),
  ...
  - [`define_extract_agg()`](https://tech.popdata.org/ipumsr/reference/define_extract_agg.md)
    ...
    [`define_extract_nhgis()`](https://tech.popdata.org/ipumsr/reference/define_extract_nhgis.md),
    which is now deprecated.
  ...
  - [`get_metadata_catalog()`](https://tech.popdata.org/ipumsr/reference/get_metadata_catalog.md)
    ...
    [`get_metadata_nhgis()`](https://tech.popdata.org/ipumsr/reference/get_metadata_nhgis.md),
    which is now deprecated.
...
- Fixes bug in
  [`add_to_extract.micro_extract()`](https://tech.popdata.org/ipumsr/reference/add_to_extract_micro.md)
...
- The ability to read IPUMS files by providing the path to their
  ...
  of
  [`read_ipums_ddi()`](https://tech.popdata.org/ipumsr/reference/read_ipums_ddi.md)—see
...
- Add
  ...
  ([`vignette("ipums-bigdata", package = "ipumsr")`](https://tech.popdata.org/ipumsr/articles/ipums-bigdata.md))
  for more details.
...
- Lots of improvements for users who wish to use “big data” sized IPUMS
  ...
  - There are now chunked versions of the microdata reading functions
    ...
    &
    [`ipumsr::read_ipums_micro_list_chunked()`](https://tech.popdata.org/ipumsr/reference/read_ipums_micro_chunked.md))
