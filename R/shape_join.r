...
#'
#' data <- read_nhgis(ipums_example("nhgis0707_csv.zip"))
#'
#' if (require(sf)) {
#'   sf <- read_ipums_sf(ipums_example("nhgis0707_shape_small.zip"))
#'   data_sf <- ipums_shape_inner_join(data, sf, by = "GISJOIN")
#' }
#'
#' if (require(sp) && require(rgdal)) {
#'   sp <- read_ipums_sp(ipums_example("nhgis0707_shape_small.zip"))
