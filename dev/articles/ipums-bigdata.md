...
to specify case selections for a variable in an extract definition. For
...
vignette](https://tech.popdata.org/ipumsr/dev/articles/value-labels.md)
more about variable metadata in IPUMS data.
