...
- On the left-hand side, use the
  [`lbl()`](https://tech.popdata.org/ipumsr/dev/reference/lbl.md) helper
  to define a new value-label pair.
...
placeholders that will be added to a given `labelled` vector:
