...
- [`read_ipums_micro_chunked()`](https://tech.popdata.org/ipumsr/dev/reference/read_ipums_micro_chunked.md)
  [`read_ipums_micro_list_chunked()`](https://tech.popdata.org/ipumsr/dev/reference/read_ipums_micro_chunked.md)
...
- [`ipums_extract-class`](https://tech.popdata.org/ipumsr/dev/reference/ipums_extract-class.md)
...
- [`ipums_var_info()`](https://tech.popdata.org/ipumsr/dev/reference/ipums_var_info.md)
  [`ipums_var_label()`](https://tech.popdata.org/ipumsr/dev/reference/ipums_var_info.md)
  [`ipums_var_desc()`](https://tech.popdata.org/ipumsr/dev/reference/ipums_var_info.md)
  [`ipums_val_labels()`](https://tech.popdata.org/ipumsr/dev/reference/ipums_var_info.md)
...
- [`ipums_file_info()`](https://tech.popdata.org/ipumsr/dev/reference/ipums_file_info.md)
  [`ipums_conditions()`](https://tech.popdata.org/ipumsr/dev/reference/ipums_file_info.md)
...
- [`lbl_relabel()`](https://tech.popdata.org/ipumsr/dev/reference/lbl_relabel.md)
  [`lbl_collapse()`](https://tech.popdata.org/ipumsr/dev/reference/lbl_relabel.md)
...
- [`lbl_add()`](https://tech.popdata.org/ipumsr/dev/reference/lbl_add.md)
  [`lbl_add_vals()`](https://tech.popdata.org/ipumsr/dev/reference/lbl_add.md)
  : Add labels for unlabelled values
- [`lbl()`](https://tech.popdata.org/ipumsr/dev/reference/lbl.md) : Make
  a label placeholder object

## Other helpers

Miscellaneous functions for working with IPUMS data

- [`ipums_bind_rows()`](https://tech.popdata.org/ipumsr/dev/reference/ipums_bind_rows.md)
...
- [`ipums_shape_left_join()`](https://tech.popdata.org/ipumsr/dev/reference/ipums_shape_join.md)
  ...
  [`ipums_shape_inner_join()`](https://tech.popdata.org/ipumsr/dev/reference/ipums_shape_join.md)
  [`ipums_shape_full_join()`](https://tech.popdata.org/ipumsr/dev/reference/ipums_shape_join.md)
