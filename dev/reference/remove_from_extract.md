...
- To remove from an **IPUMS Microdata** extract definition, click
  [here](https://tech.popdata.org/ipumsr/dev/reference/remove_from_extract.micro_extract.md).
  This includes:
...
- To remove from an **IPUMS aggregate data** extract definition, click
  [here](https://tech.popdata.org/ipumsr/dev/reference/remove_from_extract.agg_extract.md).
  This includes:
