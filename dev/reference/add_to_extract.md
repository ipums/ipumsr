...
- To add to an **IPUMS microdata** extract definition, click
  [here](https://tech.popdata.org/ipumsr/dev/reference/add_to_extract_micro.md).
  This includes:
...
- To add to an **IPUMS aggregate data** extract definition, click
  [here](https://tech.popdata.org/ipumsr/dev/reference/add_to_extract.agg_extract.md).
  This includes:
