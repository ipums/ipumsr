...
#   * inst/extdata/cps_00159.xml
#   * inst/extdata/cps_00159.dat.gz
#
# This file contains the same contents as cps_00157 and cps_00158, but is
...
define_extract_micro(
  collection = "cps",
  description = "Reproducing cps00010",
