...
- **[https://rspatial.org/](https://rspatial.org/)** has a great set of tutorials and
...
## Raster data
**Note: As of ipumsr 0.5.1, the raster package is no longer installed 
automatically when you install ipumsr. To use the raster-reading functions in 
ipumsr, you must now install the raster package explicitly, with:**
...
population and population by age on a grid.
...
been aggregated up to a geographic boundary. 
