...
Within ipumsr, you can use `var_spec()` to specify case selections for a
variable in an extract. For instance, the following would produce an extract
only including records for married women:
...
If you're using the online interface, the "Select Cases" option is usually 
