...
If you haven't already installed these packages, you can do so with:
...
Use `vignette("ipums-api")` to get more information about using the
IPUMS API to make extract requests.
...
an included variable. For example, you could select cases on `AGE` such
