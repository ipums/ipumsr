...
This dataset specification can then be provided to the extract defintion:
...
format of the extract's resulting data files. See the documentation for 
`define_extract_nhgis()` for more details on these options.
