...
comma-delimited files). Metadata files contain information
...
documentation for more details on the available options. If you've never created 
an extract for the project you're interested in, start by watching the 
project-specific video on creating extracts hosted on the 
...
codebook column, and select **Save as...** (see below).
