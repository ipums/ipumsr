...
[microdata API
request](https://tech.popdata.org/ipumsr/articles/ipums-api-micro.md)
and [aggregate data API
request](https://tech.popdata.org/ipumsr/articles/ipums-api-agg.md)
...
data](https://tech.popdata.org/ipumsr/articles/ipums-read.md) vignette.
...
See the [value
labels](https://tech.popdata.org/ipumsr/articles/value-labels.md)
